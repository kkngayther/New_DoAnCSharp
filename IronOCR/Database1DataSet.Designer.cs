...
namespace IronOCR {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(int id, string name, string session, string department) {
...
namespace IronOCR.Database1DataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Student] WHERE (([id] = @Original_id) AND ([name] = @Original_" +
                "name) AND ([session] = @Original_session) AND ([department] = @Original_departme" +
                "nt))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([id], [name], [session], [department]) VALUES (@id, " +
                "@name, @session, @department);\r\nSELECT id, name, session, department FROM Studen" +
                "t WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [id] = @id, [name] = @name, [session] = @session, [department] = @department WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([session] = @Original_session) AND ([department] = @Original_department));
SELECT id, name, session, department FROM Student WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::IronOCR.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, session, department FROM dbo.Student";
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_session, string Original_department) {
        ...
        public virtual int Insert(int id, string name, string session, string department) {
        ...
        public virtual int Update(int id, string name, string session, string department, int Original_id, string Original_name, string Original_session, string Original_department) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string session, string department, int Original_id, string Original_name, string Original_session, string Original_department) {
            return this.Update(Original_id, name, session, department, Original_id, Original_name, Original_session, Original_department);
        }
    }
